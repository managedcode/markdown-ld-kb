...
Performance analysis lives in a separate BenchmarkDotNet project that measures fuzzy edit distance, graph build/search, Tiktoken search, graph persistence/export/load, graph lifecycle, and local federated search without adding benchmark dependencies to the production library.
